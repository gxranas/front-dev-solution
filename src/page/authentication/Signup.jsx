    ...
    <>
      <Container>
        <Content>
          ...
          <Footer>
          <Label>Already have an account?</Label><Links marginLeft="5px" to="/login">Log in</Links>
          </Footer>
        </Content>
      </Container>
    </>
